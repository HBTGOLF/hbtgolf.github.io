          ...
          <table class="masters-latest-scorecard" data-hole-count="${latestHoleCount}" style="--latest-scorecard-min:${Math.max(636,330+(latestHoleCount*34))}px">
            <thead>
              <tr class="latest-scorecard-heading-row">
                ...
                <th class="latest-player-col latest-double-head" scope="col" rowspan="2">
                  <span class="latest-player-head-stack"><span>PLAYER</span><span>PAR</span></span>
                </th>
            ...
            <tbody>
              ${latestScorecardRows.map(r=>{
                ...
                const mobilePlayerDisplay=p?p.last:String(playerLabel).trim().split(/\s+/).slice(-1)[0];
