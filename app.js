          ...
          <button
            ...
            <div class="statrow" style="border-top:0">
              ...
              <div class="handicap-row-player">
                <b>${p.last}</b>
                <div class="sub">${p.hc.last20.filter(x=>x.counts).length} counting rounds</div>
              </div>
...
render=function(){
  baseRender();
  closeRetailMenu();
  requestAnimationFrame(()=>{setupRetailMenu();initScorecardYearNav();initPlayerHeadNav();initHandicapAccordions();initPremiumMotion();initHeroStatusRotation();ensureHeroVideoPlayback();});
};
