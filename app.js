...
function home(){
  ...
  const roundDateMap={
    ...
    R13:'July 21, 2026',R14:'August 4, 2026',R15:'August 11, 2026',R16:'August 25, 2026'
  };
...
<div class="hero-video-treatment" aria-hidden="true"></div>
    ...
    <div class="hero-in home-hero-in">
      ...
      <div class="hero-status hero-status-clean">
        <span>${labs.length} of ${seasonConfig().regularRounds+2} events complete</span>
