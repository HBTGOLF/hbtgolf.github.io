...
<div class="hero-video-treatment" aria-hidden="true"></div>
  ...
  <section class="page home-main">
    ...
    <section class="premium-section reveal around-tour">
      ...
      <div class="tour-stat-grid">
        <article class="tour-stat-card">
          <div class="tour-stat-kicker">Tour Leader</div>
          <div class="tour-stat-name">${L.first} ${L.last}</div>
          <div class="tour-stat-value">${fmt(L.points)} PTS</div>
          <div class="tour-stat-note">${fmt(leadGap)} points clear · 15 of 18 events complete</div>
        </article>
        <article class="tour-stat-card tour-fire-card">
          <div class="tour-stat-kicker">Who's on Fire</div>
          <div class="tour-stat-name">${hot.player.first} ${hot.player.last}</div>
          <div class="tour-stat-value">${fmt(hot.points)} PTS</div>
          <div class="tour-stat-note">Most points over the last 3 events</div>
        </article>
      </div>
    </section>
