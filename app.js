...
function rankedCard(metric,title,format,dir='max'){
  ...
  return `<div class="card statcard reveal stats-table-reveal">
    ...
    <div class="statrow statrow-leader"><div class="rank">1</div>${avatar(leader)}<div class="stat-player-name"><b>${leader.last}</b></div><div class="value">${format(leader[metric])}</div></div>
