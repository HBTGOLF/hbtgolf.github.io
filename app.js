  ...
  return `<section class="hero home-editorial-hero">
    ...
    <div class="hero-in home-hero-in">
      <div class="hero-title-wrap hero-logo-lockup">
        <div class="hero-season-lineup" aria-label="2026 Season">
          <span class="hero-season-rule" aria-hidden="true"></span>
          <span class="hero-season-overline">2026 Season</span>
          <span class="hero-season-rule" aria-hidden="true"></span>
        </div>
        <img src="assets/hbt-logo.png" alt="HBT Golf League" class="hero-logo-clean">
        <div class="hero-established">Est. 2019</div>
      </div>
