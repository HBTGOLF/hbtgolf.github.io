...
function home(){
  ...
  const statWeek=regularSeasonWinLeaders[0];
      ...
      <div class="tour-editorial-grid">
        ...
        <article class="tour-story stat-week-card">
          <div class="stat-week-copy">
            ...
            <div class="tour-story-display">${statWeek.wins}</div>
            <div class="tour-story-unit">REGULAR SEASON WINS</div>
            <div class="tour-story-note">Most wins in the league through Round 16</div>
          </div>
