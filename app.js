  ...
  return `<section class="hero home-editorial-hero">
    ...
    <div class="hero-in home-hero-in">
      <div class="hero-title-wrap hero-logo-lockup">
        <div class="hero-meta-lineup hero-established-line" aria-label="Established 2019">
          <span class="hero-meta-rule" aria-hidden="true"></span>
          <span class="hero-meta-text">Est. 2019</span>
          <span class="hero-meta-rule" aria-hidden="true"></span>
        </div>
        <img src="assets/hbt-logo.png" alt="HBT Golf League" class="hero-logo-clean">
        <div class="hero-meta-lineup hero-season-line" aria-label="2026 Season">
          <span class="hero-meta-rule" aria-hidden="true"></span>
          <span class="hero-meta-text">2026 Season</span>
          <span class="hero-meta-rule" aria-hidden="true"></span>
        </div>
      </div>
