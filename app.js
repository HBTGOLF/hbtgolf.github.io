...
function home(){
  ...
  return `<section class="hero home-editorial-hero">
    ...
    <div class="hero-in home-hero-in">
      <div class="hero-intro-black" aria-hidden="true"></div>
...
function initHeroIntro(){
  ...
  // Play once per page load; changing routes and returning home does not replay.
  ...
  setTimeout(()=>hero.classList.add('hero-logo-visible'),350);
  setTimeout(()=>hero.classList.add('hero-video-visible'),1250);
  setTimeout(()=>hero.classList.add('hero-ui-visible'),1850);
  setTimeout(()=>{
    hero.classList.add('hero-intro-complete');
